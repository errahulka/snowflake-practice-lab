# Iceberg & Cortex demo
This demo will show you how you can easily use Snowflake Cortex LLM functions for AI-powered text analysis on Iceberg tables. 
A blog post with step-by-step instructions are available [here](https://medium.com/snowflake/how-to-use-llama-2-on-iceberg-tables-for-sentiment-analysis-with-snowflake-cortex-32c030a8102b).
